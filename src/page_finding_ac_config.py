...
REGEX_CLUSTER_KEEP_RATIO = 0.75
CATEGORY_PAGE_SCORE_PERCENTILE = 0.80
CATEGORY_PAGE_SCORE_MIN = 6
CATEGORY_PAGE_SCORE_MAX = 20
CATEGORY_HIGH_SCORE_MULTIPLIER = 1.5
CATEGORY_CLUSTER_KEEP_RATIO = 0.75
CATEGORY_NEIGHBOR_SCORE_CAP = 8
